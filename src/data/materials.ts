...
export const mockMaterials: Material[] = [
  // Essenciais
  mat("mat-001", "Fios Fadvan Volume Brasileiro (caixinha)", "cilios", "caixa", 1690, 8, 3),
  mat("mat-002", "Cola para Cílios (variável)", "cilios", "un", 6290, 2, 1),
  mat("mat-003", "Removedor de Cílios", "cilios", "un", 2649, 3, 1),
  mat("mat-004", "Fio Elipse", "cilios", "un", 2500, 4, 2),
  mat("mat-005", "Adesivo Extra (backup)", "cilios", "un", 4500, 1, 1),
  mat("mat-006", "Primer", "cilios", "un", 1800, 2, 1),

  // Acessórios
  mat("mat-007", "Pinça Reta (Nagaraku)", "outros", "par", 2999, 3, 2),
  mat("mat-008", "Pinça Curva Chauffada (Santa Clara)", "outros", "un", 8000, 2, 1),
  mat("mat-009", "Pinça Ponta Agulha", "outros", "un", 8000, 1, 1),
  mat("mat-010", "Almotolia (pump espumador)", "outros", "un", 1500, 1, 1),
  mat("mat-011", "Caneta Marcadora", "outros", "un", 800, 2, 1),
  mat("mat-012", "Pedra Jade", "outros", "un", 1200, 1, 1),
  mat("mat-013", "Espelho de Dentista", "outros", "un", 2000, 1, 1),
  mat("mat-014", "Pincel para Higienização", "outros", "un", 500, 2, 1),
  mat("mat-015", "Tesourinha Ponta Reta", "outros", "un", 4000, 1, 1),
  mat("mat-016", "Suporte Acrílico", "outros", "un", 1029, 1, 1),
  mat("mat-017", "Medidor de Temperatura", "outros", "un", 2120, 1, 1),
  mat("mat-018", "Umidificador de Ar", "outros", "un", 1399, 1, 1),
  ...
  // Químicos
  mat("mat-030", "Água Micelar Loreal", "cola", "un", 2799, 2, 1),
  mat("mat-031", "Potinho Pump Up", "cola", "un", 690, 3, 1),
  mat("mat-032", "Finalizador Cherry", "cola", "un", 4890, 1, 1),
  mat("mat-033", "Bruma Navina + Nano Mister", "cola", "kit", 3650, 1, 1),
  mat("mat-034", "Frasco Difusor Água", "cola", "un", 1199, 2, 1),
  mat("mat-035", "Detergente Enzimático 1L", "cola", "un", 3000, 1, 1),
  mat("mat-036", "Álcool 70 para Higienização", "cola", "un", 3000, 1, 1),

  // Opcionais
  mat("mat-037", "Ventilador de Mão", "outros", "un", 2000, 1, 0),
  mat("mat-038", "Navalha Elétrica / Mini Navalha", "outros", "un", 4000, 1, 0),
  mat("mat-039", "Higrômetro", "outros", "un", 3500, 1, 0),

  // Kit consumíveis (Dapen, henna etc.)
  mat("mat-040", "Algodão em Disco (pacote)", "descartaveis", "pacote", 7000, 2, 1),
  mat("mat-041", "Adstringente 500ml Depil Bella", "cola", "un", 2000, 1, 1),
  mat("mat-042", "Esfoliante Depil Bella", "cola", "un", 1800, 1, 1),
  mat("mat-043", "Gel Calmante Camomila DepilBella", "cola", "un", 1800, 1, 1),
  mat("mat-044", "Borrifador de Água", "outros", "un", 2500, 1, 1),
  mat("mat-045", "Linha para Design", "cilios", "un", 1000, 3, 1),
  mat("mat-046", "Lápis Dermatográfico Preto", "cilios", "un", 10000, 2, 1),
  mat("mat-047", "Caneta em Gel Branca", "cilios", "un", 1500, 2, 1),
  mat("mat-048", "Henna cor 3 (Castanho escuro/Marrom)", "cilios", "un", 900, 3, 1),
  ...
  mat("mat-051", "Mixer para Misturar Henna", "outros", "un", 5000, 1, 1),
  mat("mat-052", "Paquímetro", "outros", "un", 4500, 1, 1),
