...
export default function AgendarSucessoPage({ params }: Props) {
  return (
    <div className="max-w-lg mx-auto text-center py-12">
      ...
      <h1 className="text-2xl font-bold text-foreground mb-3">Solicitação Enviada!</h1>
      <p className="text-muted-foreground mb-8">
        Seu agendamento foi solicitado com sucesso. A profissional irá confirmar seu horário em breve.
      </p>
