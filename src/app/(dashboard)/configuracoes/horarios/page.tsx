        ...
        <div className="bg-white rounded-2xl border border-brand-100 shadow-card overflow-hidden">
          <div className="px-5 py-4 border-b border-brand-50 flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-0.5">Dias e horários disponíveis para agendamento</p>
            </div>
          </div>
              ...
              <div className="space-y-2">
                {ALL_DAYS.map((day) => {
                  ...
                  return (
                    ...
                    >
                      {/* Always-visible row: day name + toggle badge */}
                      <div className="flex items-center gap-3 px-4 py-3">
                        <span
                          className={`w-10 text-sm font-bold flex-shrink-0 ${
                            v.isAvailable ? "text-brand-700" : "text-muted-foreground"
                          }`}
                        >
                          {DAY_NAMES[day]}
                        </span>
                ...
                {blockedDates.map((bd) => (
                  ...
                  >
                    <div className="flex-1 min-w-0">
                      ...
                      {bd.reason && (
                        <p className="text-xs text-muted-foreground mt-0.5 truncate">{bd.reason}</p>
                      )}
                    </div>
                    <button
